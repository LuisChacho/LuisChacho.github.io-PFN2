...
const questionsBank = [
  ...
  { id: 26, topic: "Cálculo de Edades", q: "Hace $n$ años la edad de Lucía era $k$ veces la de Sofía. Hoy la edad de Lucía es el doble de la de Sofía. Halle la edad actual de Sofía en términos de $n$ y $k$:", options: ["$$\\frac{n(k-1)}{k-2}$$", "$$\\frac{nk}{k-1}$$", "$$\\frac{n(k+1)}{k}$$", "$$\\frac{2nk}{k-1}$$"], correct: 0 },
